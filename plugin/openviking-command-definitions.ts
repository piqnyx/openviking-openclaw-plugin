  ...
  return [
    {
      ...
      handler: async (ctx: PluginCommandContext) => {
        try {
          ...
          return toCommandResult(await deps.addResourceOpenViking(input, session.actorPeerId, session.agentId));
        } catch (err) {
    ...
    },
    {
      ...
      handler: async (ctx: PluginCommandContext) => {
        try {
          ...
          return toCommandResult(await deps.addSkillOpenViking(input, session.actorPeerId, session.agentId));
        } catch (err) {
