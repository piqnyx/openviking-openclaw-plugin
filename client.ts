...
export class OpenVikingClient {
  ...
  async find(
    ...
    options: {
      ...
      actorPeerId?: string;
      /**
       * Уровни записей, которые нужны вызывающему. Для отзыва фактов это [2]:
       * L0 и L1 — описания каталогов, они по тематическому запросу обгоняют
       * сами записи и вытесняют их из пула кандидатов.
       */
      level?: number[];
    },
