...
export function createOpenVikingQueryRuntime(deps) {
    ...
    const readOpenVikingContent = async (input, agentId, accountAgentId) => {
    ...
    const multiReadOpenVikingContent = async (input, agentId, accountAgentId) => {
    ...
    const listOpenVikingDirectory = async (input, agentId, accountAgentId) => {
        const uri = input.uri.trim();
